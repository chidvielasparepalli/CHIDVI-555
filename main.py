...
class JarvisLive:
    ...
    async def _play_audio(self):
        ...
        try:
            while True:
                ...
                await asyncio.to_thread(stream.write, self._boost_voice_chunk(chunk))
        except Exception as e:
    ...
    async def run(self):
        ...
        while True:
            ...
            self.set_speaking(False)
            self.ui.set_state("THINKING")
            print("[JARVIS] ðŸ”„ Reconnecting in 3s...")
